...
export const FINANCE_SECTIONS = [
  ...
  { slug: "profit", label: "Ganancias", href: "/admin/finance/profit", status: "available" },
  { slug: "accounting", label: "Contabilidad", href: "/admin/finance/accounting", status: "available" },
